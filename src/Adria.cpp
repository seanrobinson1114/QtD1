    ...
    d_unused_dialogues( 21 )
{
  ...
  d_quest_dialogues[Quest::Type::PoisonWater][0].raw_dialogue_text = 
    ...
    "restore fresh water to their wells.";
  ...
  d_quest_dialogues[Quest::Type::OdgensSign][0].dialogue_file_name = "/sfx/towners/witch02.wav";
  d_quest_dialogues[Quest::Type::OdgensSign][0].raw_dialogue_text = 
  ...
  d_quest_dialogues[Quest::Type::ArchbishopLazarus][0].raw_dialogue_text = 
    ...
    "have claimed him as theirs. Archbishop Lazarus: Abandon your "
    "foolish quest. All that awaits you is the wrath of my Master! "

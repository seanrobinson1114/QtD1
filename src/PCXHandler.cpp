...
//!
//! \file   PCXHandler.cpp
//! \brief  The PCXHandler and plugin implementation have been taken from
//!         the KDE project. Only minor modifications to the original source
//!         have been made. The original copyright notice is shown below:
...
auto PCXPlugin::capabilities(QIODevice *device, const QByteArray &format) const
  -> Capabilities
{
    if (format == "pcx") {
...
// Export the plugin
Q_EXPORT_PLUGIN2(pcx, QtD1::PCXPlugin)
